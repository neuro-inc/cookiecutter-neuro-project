...
TIMEOUT_MAKE_UPLOAD_DATA = TIMEOUT_MAKE_DOWNLOAD_DATA = 500
TIMEOUT_MAKE_CLEAN_DATA = 50
TIMEOUT_MAKE_UPLOAD_CONFIG = TIMEOUT_MAKE_DOWNLOAD_CONFIG = 10
...
def _get_pattern_connected_ssh() -> str:
    return r"Warning: Permanently added '.+' (ECDSA) to the list of known hosts"
