...
.PHONY: test_e2e_dev
test_e2e_dev:
	TRAINING_MACHINE_TYPE=cpu-small pytest -s --environment=dev --tb=short --reruns=2 tests/e2e

.PHONY: test_e2e_staging
test_e2e_staging:
	TRAINING_MACHINE_TYPE=gpu-small pytest -s --environment=staging --tb=short --reruns=2 tests/e2e
