...
|:------------------------------------ |:----------------- |:---------------------------------------------------------------------------- |:-------------------------- | 
| `data/`                              | Data              | `storage:name-of-the-project/data/`                              | `/name-of-the-project/data/` | 
| `modules/` | Python modules    | `storage:name-of-the-project/modules/` | `/name-of-the-project/modules/` |
| `config/`                            | Configuration files | `storage:name-of-the-project/config/`                          | `/name-of-the-project/modules/` |
| `notebooks/`                         | Jupyter notebooks | `storage:name-of-the-project/notebooks/`                         | `/name-of-the-project/notebooks/` |
| No directory                         | Logs and results  | `storage:name-of-the-project/results/`                           | `/name-of-the-project/results/` |
...
into `storage:name-of-the-project/data` mounted to your development environment's `/project/data`.
